	...
	public function showPagination($link)
	{
		...
		if ($this->totalPage > 1) {
			if ($this->currentPage > 1) {
				...
				$start 	= '<li class="page-item disabled"><a class="page-link" href="' . $link . 'page=1"><i class="fas fa-angle-double-left"></i></a></li>';
				$prev 	= '<li class="page-item disabled"><a class="page-link" href="' . $link . 'page=' . ($this->currentPage - 1) . '"><i class="fas fa-angle-left"></i></a></li>';
			}
			...
			if ($this->currentPage < $this->totalPage) {
				...
				$next 	= '<li class="page-item disabled"><a class="page-link" href="' . $link . 'page=' . ($this->currentPage + 1) . '"><i class="fas fa-angle-right"></i></a></li>';
				$end 	= '<li class="page-item disabled"><a class="page-link" href="' . $link . 'page=' . $this->totalPage . '"><i class="fas fa-angle-double-right"></i></a></li>';
			}
			...
			for ($i = $startPage; $i <= $endPage; $i++) {
				if ($i == $this->currentPage) {
					$listPages .= '<li class="page-item"><span class="page-link">' . $i . '</span></li>';
				} else {
